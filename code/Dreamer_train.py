...
def train_model(
    ...
    config = (
        ...
        #.framework(framework="torch_compile")
        # .api_stack(
    ...
    if continue_previous:
        ...
        if start_from_zero is False:
            ...
            algo = DreamerV3(config)
            print(str(latest_checkpoint_dir))
            algo.restore(str(latest_checkpoint_dir))
    ...
    while True:
        ...
        #         _temp_dir=temp_dir,
        #     )
        #     algo = DreamerV3.from_checkpoint(checkpoint_path)
